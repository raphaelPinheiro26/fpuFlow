...
def main():
    ...
    if compiled_projects:
        # Relatórios tradicionais (mantém compatibilidade)
        report_generator.generate_all_reports(compiled_projects)
        print("✅ Relatórios consolidados gerados")
        
        # NOVO: Relatórios hierárquicos (simplificado)
        hierarchical_reports.generate_hierarchical_reports(compiled_projects, dependencies)
    else:
